 ...
 * Styled per DESIGN.md: achromatic, border-first, Geist typography.
 */
export const resightsCatalog = defineCatalog(schema, {
  components: {
    Card: {
      ...
      slots: ["default"],
      description: "Bordered surface container. Do not nest Card inside Card.",
    },
    Stack: {
      props: z.object({
    ...
    Separator: {
      props: z.object({}),
      description: "1px hairline divider.",
    },
    Metric: {
      props: z.object({
        label: z.string(),
